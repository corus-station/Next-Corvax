...
[Dependency] private readonly IPrototypeManager _prototype = default!; // Corvax-Next
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ClumsyComponent, ComponentInit>(OnInit); // Corvax-Next
    }

    private void OnInit(Entity<ClumsyComponent> ent, ref ComponentInit args) // Corvax-Next
    {
